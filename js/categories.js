...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    document
        ...
        .addEventListener('click', () =>
            showCategoriesList(filteredCategories, ORDER_ASC_BY_NAME)
        );
    document
        .getElementById('sortDesc')
        .addEventListener('click', () =>
            showCategoriesList(filteredCategories, ORDER_DESC_BY_NAME)
        );
    ...
    document
        ...
        .addEventListener('click', filterArray);
    document
        .getElementById('clearRangeFilter')
        .addEventListener('click', cleanFilters);
...
function toggleProductCount() {
    ...
    showCategoriesList(filteredCategories, ORDER_BY_PROD_COUNT);
}
...
function filterArray() {
    ...
    filteredCategories = categoriesArray.filter(
        ({ productCount }) =>
            +productCount >= minValue && +productCount <= maxValue
    );

    showCategoriesList(filteredCategories, currentSortCriteria);
}
